// This module centralizes the large pieces of descriptive text used on the
// DAO information page. Keeping the strings here (or in markdown files in
// the future) makes them editable by non‑developers and keeps the page
// component clean.
